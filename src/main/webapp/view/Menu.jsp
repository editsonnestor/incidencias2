    ...
    <body>
        <form>
            <div class="sidebar">
                ...
                <hr/>
                <a href="oficina?menu=Oficina&accion=ListarOficina"  target="marco" id="oficinasLink"><i class="bi bi-house-door"></i> Oficinas</a>
                <a href="equipo?menu=Equipo&accion=ListarEquipo" target="marco" id="equiposLink"><i class="bi bi-box"></i> Equipos</a>
                ...
                <a href="incidencia?menu=Incidencia&accion=ListarAtencion" target="marco" id="atencionLink"><i class="bi bi-headset"></i> Atención</a>
                <a href="usuario?menu=Usuario&accion=ListarUsuario" target="marco" id="atencionLink"><i class="bi bi-person"></i> Usuarios</a>
